...
var _View_ErrorComponent_Host0 = (function (_super) {
    ...
    _View_ErrorComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('app-as-error', rootSelector, null);
...
export var ErrorComponentNgFactory = new import10.ComponentFactory('app-as-error', viewFactory_ErrorComponent_Host0, import3.ErrorComponent);
...
var _View_ErrorComponent0 = (function (_super) {
    ...
    _View_ErrorComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_11 = this.renderer.createElement(this._el_8, 'h4', null);
        ...
        this._el_15 = this.renderer.createElement(this._el_6, 'div', null);
        this.renderer.setElementAttribute(this._el_15, 'class', 'modal-body');
        this._text_16 = this.renderer.createText(this._el_15, '\n                ', null);
        this._el_17 = this.renderer.createElement(this._el_15, 'p', null);
        ...
        this._text_24 = this.renderer.createText(this._el_23, 'Close', null);
    ...
    _View_ErrorComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.NgStyle) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 28)))) {
    ...
    _View_ErrorComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        this.detectContentChildrenChanges(throwOnChange);
        var currVal_2 = import4.interpolate(1, '', ((this.context.error == null) ? null : this.context.error.title), '');
        if (import4.checkBinding(throwOnChange, this._expr_2, currVal_2)) {
            this.renderer.setText(this._text_12, currVal_2);
            this._expr_2 = currVal_2;
        }
        var currVal_3 = import4.interpolate(1, '', ((this.context.error == null) ? null : this.context.error.message), '');
    ...
    _View_ErrorComponent0.prototype._handle_click_23_0 = function ($event) {
...
export function viewFactory_ErrorComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ErrorComponent === null)) {
        (renderType_ErrorComponent = viewUtils.createRenderComponentType('C:/Users/Abdullah/Desktop/BSc_Computer_Science/sa/docker/assets/app/errors/error.component.html', 0, import9.ViewEncapsulation.Emulated, styles_ErrorComponent, {}));
    }
