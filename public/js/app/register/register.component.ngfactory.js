...
var renderType_RegisterComponent_Host = null;
var _View_RegisterComponent_Host0 = (function (_super) {
    __extends(_View_RegisterComponent_Host0, _super);
    function _View_RegisterComponent_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_RegisterComponent_Host0, renderType_RegisterComponent_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_RegisterComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('app-as-register', rootSelector, null);
        this._appEl_0 = new import2.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_RegisterComponent0(this.viewUtils, this.injector(0), this._appEl_0);
        ...
        compView_0.create(this._RegisterComponent_0_4, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_RegisterComponent_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import3.RegisterComponent) && (0 === requestNodeIndex))) {
            return this._RegisterComponent_0_4;
        }
        return notFoundResult;
    };
    _View_RegisterComponent_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._RegisterComponent_0_4.ngOnInit();
        }
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_RegisterComponent_Host0;
}(import1.AppView));
function viewFactory_RegisterComponent_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_RegisterComponent_Host === null)) {
        (renderType_RegisterComponent_Host = viewUtils.createRenderComponentType('', 0, import11.ViewEncapsulation.None, [], {}));
    }
    return new _View_RegisterComponent_Host0(viewUtils, parentInjector, declarationEl);
}
export var RegisterComponentNgFactory = new import12.ComponentFactory('app-as-register', viewFactory_RegisterComponent_Host0, import3.RegisterComponent);
var styles_RegisterComponent = [];
var renderType_RegisterComponent = null;
var _View_RegisterComponent0 = (function (_super) {
    __extends(_View_RegisterComponent0, _super);
    function _View_RegisterComponent0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_RegisterComponent0, renderType_RegisterComponent, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_RegisterComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._FormGroupDirective_2_3 = new import13.FormGroupDirective(null, null);
        ...
        this._FormControlName_9_5 = new import16.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_9_4);
        ...
        this._FormControlName_17_5 = new import16.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_17_4);
        ...
        this._FormControlName_25_5 = new import16.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_25_4);
        ...
        this._FormControlName_33_5 = new import16.FormControlName(this._ControlContainer_2_4, null, null, this._NG_VALUE_ACCESSOR_33_4);
    ...
    _View_RegisterComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import16.FormControlName) && (9 === requestNodeIndex))) {
        ...
        if (((token === import18.NG_VALUE_ACCESSOR) && (17 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_17_4;
        }
        if (((token === import16.FormControlName) && (17 === requestNodeIndex))) {
            return this._FormControlName_17_5;
        }
        if (((token === import19.NgControl) && (17 === requestNodeIndex))) {
            return this._NgControl_17_6;
        }
        if (((token === import14.NgControlStatus) && (17 === requestNodeIndex))) {
        ...
        if (((token === import16.FormControlName) && (25 === requestNodeIndex))) {
            return this._FormControlName_25_5;
        }
        if (((token === import19.NgControl) && (25 === requestNodeIndex))) {
            return this._NgControl_25_6;
        }
        if (((token === import14.NgControlStatus) && (25 === requestNodeIndex))) {
        ...
        if (((token === import16.FormControlName) && (33 === requestNodeIndex))) {
            return this._FormControlName_33_5;
        }
        if (((token === import19.NgControl) && (33 === requestNodeIndex))) {
            return this._NgControl_33_6;
        }
        if (((token === import14.NgControlStatus) && (33 === requestNodeIndex))) {
            return this._NgControlStatus_33_7;
        }
        if (((token === import13.FormGroupDirective) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._FormGroupDirective_2_3;
        }
        if (((token === import20.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._ControlContainer_2_4;
        }
        if (((token === import14.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 38)))) {
            return this._NgControlStatusGroup_2_5;
        }
        return notFoundResult;
    };
    _View_RegisterComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var changes = null;
        changes = null;
    ...
    _View_RegisterComponent0.prototype.destroyInternal = function () {
    ...
    _View_RegisterComponent0.prototype._handle_ngSubmit_2_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this.context.onSubmit() !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_submit_2_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._FormGroupDirective_2_3.onSubmit() !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_reset_2_2 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._FormGroupDirective_2_3.onReset() !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_input_9_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_9_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_blur_9_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_9_3.onTouched() !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_input_17_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_17_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_blur_17_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_17_3.onTouched() !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_input_25_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_25_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_blur_25_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_25_3.onTouched() !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_input_33_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_33_3.onChange($event.target.value) !== false);
        return (true && pd_0);
    };
    _View_RegisterComponent0.prototype._handle_blur_33_1 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = (this._DefaultValueAccessor_33_3.onTouched() !== false);
        return (true && pd_0);
    };
    return _View_RegisterComponent0;
}(import1.AppView));
export function viewFactory_RegisterComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_RegisterComponent === null)) {
        (renderType_RegisterComponent = viewUtils.createRenderComponentType('C:/Users/Abdullah/Desktop/BSc_Computer_Science/sa/docker/assets/app/register/register.component.html', 0, import11.ViewEncapsulation.None, styles_RegisterComponent, {}));
    }
